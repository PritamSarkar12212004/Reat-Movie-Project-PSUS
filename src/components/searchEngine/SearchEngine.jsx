    ...
    <div className="flex items-center max-w-sm mx-auto mt-2 relative z-10">
      ...
      <div className="relative w-full">
        <input
          ...
          type="text"
          id="simple-search"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500  block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  dark:focus:border-blue-500  outline-none"
